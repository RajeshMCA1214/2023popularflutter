...
class ScanBin extends StatefulWidget {
  ScanBin({Key? key}) : super(key: key);

  @override
  State<ScanBin> createState() => _ScanBin();
}

class _ScanBin extends State<ScanBin> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              /*  SizedBox(
                  width: 250,
                  height: 80,
                  child: getButton(context, blueColor, "Scan Bin QR", Colors.white, () {
